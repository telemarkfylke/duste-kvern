...
Function Update-DUSTADUsers {
    ...
    # Ansatt VTFK
    $adUsers += GetADUser -Domain "login.top.no" -Filter "(extensionAttribute14 -ne '$filterVekkExt14' -or extensionAttribute14 -notlike '*')" -Properties memberOf,givenName,sn,displayName,employeeNumber,extensionAttribute4,extensionAttribute6,extensionAttribute7,extensionAttribute9,extensionAttribute14,company,physicalDeliveryOfficeName,mail,proxyAddresses,title,state -OnlyAutoUsers | Select-Object userPrincipalName, samAccountName, givenName, mail, proxyAddresses, @{N="userType"; E={"ansattVTFK"}}, @{N="surName"; E={$_.sn}}, displayName, @{N="domain"; E={"login"}}, employeeNumber, @{N="timestamp"; E={Get-Date -Format o}}, enabled, @{N="countyOU"; E={"VTFK"}}, @{N="ou"; E={"AUTO USERS"}}, extensionAttribute7, extensionAttribute9, extensionAttribute14, @{N="departmentShort"; E={$_.extensionAttribute6}}, @{N="departmentAdditional"; E={$_.extensionAttribute4}}, @{N="office"; E={$_.physicalDeliveryOfficeName}}, @{N="company"; E={$_.company}}, title, state, @{N="feide"; E={if ($_.memberOf -like "*VT-ALLE-LÆRERE*") {$True} else {$False}}}
    # Elever VTFK
    Write-Host "Finding 'AUTO USERS' from skole.top.no : $(Get-Date -Format 'HH:mm:ss')" -Verbose
    $adUsers += GetADUser -Domain "skole.top.no" -Filter "Title -eq 'Elev' -and (extensionAttribute14 -ne '$filterVekkExt14' -or extensionAttribute14 -notlike '*')" -Properties givenName,sn,displayName,employeeNumber,department,company,mail,proxyAddresses,title -OnlyAutoUsers | Select-Object userPrincipalName, samAccountName, givenName, mail, proxyAddresses, @{N="userType"; E={"elevVTFK"}}, @{N="surName"; E={$_.sn}}, displayName, @{N="domain"; E={"skole"}}, employeeNumber, @{N="timestamp"; E={Get-Date -Format o}}, enabled, @{N="countyOU"; E={"VTFK"}}, @{N="ou"; E={"AUTO USERS"}}, @{N="departmentShort"; E={$_.department}}, @{N="office"; E={$_.company}}, @{N="company"; E={$_.company}}, title

    # get ad XFYLKE users from AUTO USERS
    Write-Host "Finding 'AUTO USERS' from login.top.no : $(Get-Date -Format 'HH:mm:ss')" -Verbose
    # Ansatt XFYLKE
    $adUsers += GetADUser -Domain "login.top.no" -OU $countyOU -Filter "*" -Properties memberOf,givenName,sn,displayName,employeeNumber,extensionAttribute4,extensionAttribute6,extensionAttribute7,extensionAttribute9,extensionAttribute14,company,physicalDeliveryOfficeName,mail,proxyAddresses,title,state -OnlyAutoUsers | Select-Object userPrincipalName, samAccountName, givenName, mail, proxyAddresses, @{N="userType"; E={"ansatt$countyOU"}}, @{N="surName"; E={$_.sn}}, displayName, @{N="domain"; E={"login"}}, employeeNumber, @{N="timestamp"; E={Get-Date -Format o}}, enabled, @{N="countyOU"; E={$countyOU}}, @{N="ou"; E={"AUTO USERS"}}, extensionAttribute7, extensionAttribute9, extensionAttribute14, @{N="departmentShort"; E={$_.extensionAttribute6}}, @{N="departmentAdditional"; E={$_.extensionAttribute4}}, @{N="office"; E={$_.physicalDeliveryOfficeName}}, @{N="company"; E={$_.company}}, title, state, @{N="feide"; E={if ($_.memberOf -like "*VT-ALLE-LÆRERE*") {$True} else {$False}}}
    ...
    # Lærling VTFK
    $adUsers += GetADUser -Domain "skole.top.no" -Filter "Title -eq 'Lærling' -and (extensionAttribute14 -ne '$filterVekkExt14' -or extensionAttribute14 -notlike '*')" -Properties givenName,sn,displayName,employeeNumber,department,company,mail,proxyAddresses,title -OnlyAutoUsers | Select-Object userPrincipalName, samAccountName, givenName, mail, proxyAddresses, @{N="userType"; E={"larlingVTFK"}}, @{N="surName"; E={$_.sn}}, displayName, @{N="domain"; E={"skole"}}, employeeNumber, @{N="timestamp"; E={Get-Date -Format o}}, enabled, @{N="countyOU"; E={"VTFK"}}, @{N="ou"; E={"AUTO USERS"}}, @{N="departmentShort"; E={$_.department}}, @{N="office"; E={$_.company}}, @{N="company"; E={$_.company}}, title

    # get ad ot kids from AUTO USERS
    Write-Host "Finding OT 'AUTO USERS' from skole.top.no : $(Get-Date -Format 'HH:mm:ss')" -Verbose
    # OT VTFK
    $adUsers += GetADUser -Domain "skole.top.no" -Filter "(extensionAttribute14 -ne '$filterVekkExt14' -or extensionAttribute14 -notlike '*')" -Base "USERS OT" -Properties givenName,sn,displayName,employeeNumber,department,company,mail,proxyAddresses,title -OnlyAutoUsers | Select-Object userPrincipalName, samAccountName, givenName, mail, proxyAddresses, @{N="userType"; E={"otVTFK"}}, @{N="surName"; E={$_.sn}}, displayName, @{N="domain"; E={"skole"}}, employeeNumber, @{N="timestamp"; E={Get-Date -Format o}}, enabled, @{N="countyOU"; E={"VTFK"}}, @{N="ou"; E={"AUTO USERS"}}, @{N="departmentShort"; E={$_.department}}, @{N="office"; E={$_.company}}, @{N="company"; E={$_.company}}, title
    ...
    $adUsers += GetADUser -Domain "login.top.no" -Filter "(extensionAttribute14 -ne '$filterVekkExt14' -or extensionAttribute14 -notlike '*')" -Properties memberOf,givenName,sn,displayName,employeeNumber,extensionAttribute4,extensionAttribute6,extensionAttribute7,extensionAttribute9,extensionAttribute14,company,physicalDeliveryOfficeName,mail,proxyAddresses,title,state -OnlyDisabledAutoUsers | Select-Object userPrincipalName, samAccountName, givenName, mail, proxyAddresses, @{N="userType"; E={"ansattVTFK"}}, @{N="surName"; E={$_.sn}}, displayName, @{N="domain"; E={"login"}}, employeeNumber, @{N="timestamp"; E={Get-Date -Format o}}, enabled, @{N="countyOU"; E={"VTFK"}}, @{N="ou"; E={"AUTO DISABLED USERS"}}, extensionAttribute7, extensionAttribute9, extensionAttribute14, @{N="departmentShort"; E={$_.extensionAttribute6}}, @{N="departmentAdditional"; E={$_.extensionAttribute4}}, @{N="office"; E={$_.physicalDeliveryOfficeName}}, @{N="company"; E={$_.company}}, title, state, @{N="feide"; E={if ($_.memberOf -like "*VT-ALLE-LÆRERE*") {$True} else {$False}}}
    ...
    $adUsers += GetADUser -Domain "skole.top.no" -Filter "Title -eq 'Lærling' -and (extensionAttribute14 -ne '$filterVekkExt14' -or extensionAttribute14 -notlike '*')" -Properties givenName,sn,displayName,employeeNumber,department,company,mail,proxyAddresses,title -OnlyDisabledAutoUsers | Select-Object userPrincipalName, samAccountName, givenName, mail, proxyAddresses, @{N="userType"; E={"larlingVTFK"}}, @{N="surName"; E={$_.sn}}, displayName, @{N="domain"; E={"skole"}}, employeeNumber, @{N="timestamp"; E={Get-Date -Format o}}, enabled, @{N="countyOU"; E={"VTFK"}}, @{N="ou"; E={"AUTO DISABLED USERS"}}, @{N="departmentShort"; E={$_.department}}, @{N="office"; E={$_.company}}, @{N="company"; E={$_.company}}, title
    ...
    # OT VTFK disabled
    $adUsers += GetADUser -Domain "skole.top.no" -Filter "(extensionAttribute14 -ne '$filterVekkExt14' -or extensionAttribute14 -notlike '*')" -Base "USERS OT" -Properties givenName,sn,displayName,employeeNumber,department,company,mail,proxyAddresses,title -OnlyDisabledAutoUsers | Select-Object userPrincipalName, samAccountName, givenName, mail, proxyAddresses, @{N="userType"; E={"otVTFK"}}, @{N="surName"; E={$_.sn}}, displayName, @{N="domain"; E={"skole"}}, employeeNumber, @{N="timestamp"; E={Get-Date -Format o}}, enabled, @{N="countyOU"; E={"VTFK"}}, @{N="ou"; E={"AUTO DISABLED USERS"}}, @{N="departmentShort"; E={$_.department}}, @{N="office"; E={$_.company}}, @{N="company"; E={$_.company}}, title
