...
Function Update-DUSTADUsers {
    ...
    # Ansatt VTFK
    $adUsers += GetADUser -Domain "login.top.no" -Filter "extensionAttribute14 -ne '$($filterVekkExt14)'" -Properties memberOf,givenName,sn,displayName,employeeNumber,extensionAttribute4,extensionAttribute6,extensionAttribute7,extensionAttribute9,extensionAttribute14,company,physicalDeliveryOfficeName,mail,proxyAddresses,title,state -OnlyAutoUsers | Select-Object userPrincipalName, samAccountName, givenName, mail, proxyAddresses, @{N="type"; E={"ansattVTFK"}}, @{N="surName"; E={$_.sn}}, displayName, @{N="domain"; E={"login"}}, employeeNumber, @{N="timestamp"; E={Get-Date -Format o}}, enabled, @{N="countyOU"; E={"VTFK"}}, @{N="ou"; E={"AUTO USERS"}}, extensionAttribute7, extensionAttribute9, extensionAttribute14, @{N="departmentShort"; E={$_.extensionAttribute6}}, @{N="departmentAdditional"; E={$_.extensionAttribute4}}, @{N="office"; E={$_.physicalDeliveryOfficeName}}, @{N="company"; E={$_.company}}, title, state, @{N="feide"; E={if ($_.memberOf -like "*VT-ALLE-LÆRERE*") {$True} else {$False}}}
    # Elever VTFK
    Write-Host "Finding 'AUTO USERS' from skole.top.no : $(Get-Date -Format 'HH:mm:ss')" -Verbose
    $adUsers += GetADUser -Domain "skole.top.no" -Filter "Title -eq 'Elev' -and extensionAttribute14 -ne '$($filterVekkExt14)'" -Properties givenName,sn,displayName,employeeNumber,department,company,mail,proxyAddresses,title -OnlyAutoUsers | Select-Object userPrincipalName, samAccountName, givenName, mail, proxyAddresses, @{N="surName"; E={$_.sn}}, displayName, @{N="domain"; E={"skole"}}, employeeNumber, @{N="timestamp"; E={Get-Date -Format o}}, enabled, @{N="countyOU"; E={"VTFK"}}, @{N="ou"; E={"AUTO USERS"}}, @{N="departmentShort"; E={$_.department}}, @{N="office"; E={$_.company}}, @{N="company"; E={$_.company}}, title
    ...
    # Lærling VTFK
    $adUsers += GetADUser -Domain "skole.top.no" -Filter "Title -eq 'Lærling' -and extensionAttribute14 -ne '$($filterVekkExt14)'" -Properties givenName,sn,displayName,employeeNumber,department,company,mail,proxyAddresses,title -OnlyAutoUsers | Select-Object userPrincipalName, samAccountName, givenName, mail, proxyAddresses, @{N="surName"; E={$_.sn}}, displayName, @{N="domain"; E={"skole"}}, employeeNumber, @{N="timestamp"; E={Get-Date -Format o}}, enabled, @{N="countyOU"; E={"VTFK"}}, @{N="ou"; E={"AUTO USERS"}}, @{N="departmentShort"; E={$_.department}}, @{N="office"; E={$_.company}}, @{N="company"; E={$_.company}}, title

    # get ad ot kids from AUTO USERS
    Write-Host "Finding OT 'AUTO USERS' from skole.top.no : $(Get-Date -Format 'HH:mm:ss')" -Verbose
    # OT VTFK
    $adUsers += GetADUser -Domain "skole.top.no" -Filter "extensionAttribute14 -ne '$($filterVekkExt14)'" -Base "USERS OT" -Properties givenName,sn,displayName,employeeNumber,department,company,mail,proxyAddresses,title -OnlyAutoUsers | Select-Object userPrincipalName, samAccountName, givenName, mail, proxyAddresses, @{N="surName"; E={$_.sn}}, displayName, @{N="domain"; E={"skole"}}, employeeNumber, @{N="timestamp"; E={Get-Date -Format o}}, enabled, @{N="countyOU"; E={"VTFK"}}, @{N="ou"; E={"AUTO USERS"}}, @{N="departmentShort"; E={$_.department}}, @{N="office"; E={$_.company}}, @{N="company"; E={$_.company}}, title
    ...
    # Elev VTFK disabled
    $adUsers += GetADUser -Domain "skole.top.no" -Filter "Title -eq 'Elev' -and extensionAttribute14 -ne '$($filterVekkExt14)'" -Properties givenName,sn,displayName,employeeNumber,department,company,mail,proxyAddresses,title -OnlyDisabledAutoUsers | Select-Object userPrincipalName, samAccountName, givenName, mail, proxyAddresses, @{N="surName"; E={$_.sn}}, displayName, @{N="domain"; E={"skole"}}, employeeNumber, @{N="timestamp"; E={Get-Date -Format o}}, enabled, @{N="countyOU"; E={"VTFK"}}, @{N="ou"; E={"AUTO DISABLED USERS"}}, @{N="departmentShort"; E={$_.department}}, @{N="office"; E={$_.company}}, @{N="company"; E={$_.company}}, title
    ...
    $adUsers += GetADUser -Domain "skole.top.no" -Filter "Title -eq 'Lærling' -and extensionAttribute14 -ne '$($filterVekkExt14)'" -Properties givenName,sn,displayName,employeeNumber,department,company,mail,proxyAddresses,title -OnlyDisabledAutoUsers | Select-Object userPrincipalName, samAccountName, givenName, mail, proxyAddresses, @{N="surName"; E={$_.sn}}, displayName, @{N="domain"; E={"skole"}}, employeeNumber, @{N="timestamp"; E={Get-Date -Format o}}, enabled, @{N="countyOU"; E={"VTFK"}}, @{N="ou"; E={"AUTO DISABLED USERS"}}, @{N="departmentShort"; E={$_.department}}, @{N="office"; E={$_.company}}, @{N="company"; E={$_.company}}, title
    ...
    # OT VTFK disabled
    $adUsers += GetADUser -Domain "skole.top.no" -Filter "extensionAttribute14 -ne '$($filterVekkExt14)'" -Base "USERS OT" -Properties givenName,sn,displayName,employeeNumber,department,company,mail,proxyAddresses,title -OnlyDisabledAutoUsers | Select-Object userPrincipalName, samAccountName, givenName, mail, proxyAddresses, @{N="surName"; E={$_.sn}}, displayName, @{N="domain"; E={"skole"}}, employeeNumber, @{N="timestamp"; E={Get-Date -Format o}}, enabled, @{N="countyOU"; E={"VTFK"}}, @{N="ou"; E={"AUTO DISABLED USERS"}}, @{N="departmentShort"; E={$_.department}}, @{N="office"; E={$_.company}}, @{N="company"; E={$_.company}}, title
